...
export default function TopCreators() {
	const creators = [
		{ name: "Ova Hawkins", rank: 1, revenue: "2.4k XLM" },
		{ name: "Jacob Jones", rank: 2, revenue: "1.8k XLM" },
		{ name: "Jenny Wilson", rank: 3, revenue: "1.2k XLM" },
		{ name: "Floyd Miles", rank: 4, revenue: "950 XLM" },
		{ name: "Arlene McCoy", rank: 5, revenue: "840 XLM" },
	];
